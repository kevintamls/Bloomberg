"""File that contains all the bars that could be used in a rap battle."""

hard_bars = [
    "Not to brag, I dont mean to boast, look, my face is pale, but you look like youve seen a ghost",
    "Im bout to make this mic short circuit, this beat is wack and fits you perfect",
    "Im about eight thousand miles away from home, thinking about the throne I got my eyes fixated on",
    "No wonder youre sore now, lordy youre bored now, im pushing 30 youre breaking 40s door down",
...
medium_bars = [
    "I dont exactly hate you, but if you were on fire and I had water, id drink it",
    "Did you know they used to be called jumpolines until your mum jumped on one",
    "Your family tree must be a cactus because everyone on it is a prick",
    "It must be difficult for you, exhausting your entire vocabulary in one bar",
    "Hey why dont you give me your phone number and I will call you when I give a shit",
...
easy_bars = [
    ...
    "You beef with me, imma even the score equally",
    "No, no, im not insulting you, im describing you",
    "I could eat a bowl of alphabet soup and shit better bars than you",
    "Man, youre so fat, youre the reason why double doors were invented",
    "If I wanted to kill myself id climb your ego and jump to your IQ",
    "Youll never be the man your mother is",
    "Im sorry, was I meant to be offended, the only thing offending here is your face",
    "Someday youll go far... and I hope you stay there",
...
legendary_bars = [
    ...
    "Dont ever try to judge me dude, you don't know what the fuck ive been through, but I know something about you, you went to cranbrook, thats a private school",
